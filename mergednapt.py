...
from transformers import LlamaForCausalLM, LlamaTokenizerFast  # 修改：使用 LlamaTokenizerFast
...
if __name__ == '__main__':
    ...
    for lora_index, lora_model_path in enumerate(lora_model_paths):
        ...
        # 修改：使用 LlamaTokenizerFast 代替 LlamaTokenizer
    ...
    if output_type == 'huggingface':
        ...
        base_model.save_pretrained(output_dir)  # 修改：直接使用 base_model.save_pretrained
